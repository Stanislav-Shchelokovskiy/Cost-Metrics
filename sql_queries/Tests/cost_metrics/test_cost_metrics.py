...
def test_reactivates():
    with db(
        up='sql_queries/Tests/cost_metrics/migrations/up.sql',
        down='sql_queries/Tests/cost_metrics/migrations/down.sql',
    ):
        got: DataFrame = RemoteRepository.cost_metrics.get_data(
            start='2022-09-01',
            end='2023-08-01',
            employees_json='',
