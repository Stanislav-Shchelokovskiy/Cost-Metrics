...
VALUES						(	@emp1,		DATEADD(MONTH, -6, @now),	'Level',			NULL,		NULL,		@support_developer_ph,	@junior1,			@philippines,			NULL,		NULL		),
							(	@emp1,		DATEADD(MONTH, -5, @now),	'Level',			NULL,		NULL,		@support_developer_ph,	@junior2,			@philippines,			NULL,		NULL		),
							(	@emp1,		DATEADD(MONTH, -4, @now),	'Level',			NULL,		NULL,		@support_developer_ph,	@junior3,			@philippines,			NULL,		NULL		),
							(	@emp1,		DATEADD(MONTH, -3, @now),	'Level',			NULL,		NULL,		@support_developer_ph,	@junior4,			@philippines,			NULL,		NULL		),
							(	@emp1,		DATEADD(MONTH, -2, @now),	'Level',			NULL,		NULL,		@support_developer_ph,	@middle1,			@philippines,			NULL,		NULL		),
							(	@emp1,		DATEADD(MONTH, -1, @now),	'Level',			NULL,		NULL,		@support_developer_ph,	@middle2,			@philippines,			NULL,		NULL		)
